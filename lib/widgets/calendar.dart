    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _DateBox(date: date, isCurrent: isCurrent, isPast: isPast, isFuture: isFuture);
        },
      ),
    );
  }
...
class _DateBox extends StatelessWidget {
  ...
  const _DateBox({required this.date, required this.isCurrent, required this.isPast, required this.isFuture});
    ...
    return Opacity(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isCurrent ? Colors.black26 : (isPast ? Colors.black26 : Colors.black12), width: 2),
        ),
        child: Column(
          ...
          children: [
            Text(
              _getDayName(date),
              style: TextStyle(color: isCurrent ? Colors.white : (isPast ? Colors.black54 : Colors.black87), fontWeight: FontWeight.bold),
            ),
