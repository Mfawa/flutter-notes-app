  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.create_new_folder_rounded), onPressed: _showCategoryModal),
          IconButton(icon: const Icon(Icons.delete), onPressed: _confirmDelete),
        ],
      ),
      extendBody: true,
      bottomNavigationBar: PreferredSize(preferredSize: Size(100, 500), child: _buildFormattingBar()),
                                    ...
                                    children: [
                                      RadioListTile<String>(
                                        title: Row(
                                          children: [
                                            Container(
                                              width: 20,
                                              height: 20,
                                              decoration: BoxDecoration(color: category.color, borderRadius: BorderRadius.circular(50)),
                                            ),
                                        ...
                                        onChanged: (value) {
                                          ...
                                          ref.read(notesProvider.notifier).updateNote(widget.note.copyWith(category: value));
                                        },
                                      ),
                                      Divider(),
                                    ],
      ...
      builder:
          (_) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                TextField(controller: categoryController, decoration: const InputDecoration(labelText: 'Category Name')),
                const SizedBox(height: 16),
                BlockPicker(pickerColor: selectedColor, onColorChanged: (color) => selectedColor = color),
              ],
            ),
            actions: [
              TextButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel')),
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () => setState(() => _alignment = TextAlign.justify),
          ),
          IconButton(
            color: _alignment == TextAlign.left ? Colors.blue : Colors.black,
            icon: Icon(Icons.format_align_left),
            onPressed: () => setState(() => _alignment = TextAlign.left),
          ),
          IconButton(
