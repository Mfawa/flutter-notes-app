...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.sort), onPressed: () => _showSortDialog(context, ref)),
          // IconButton(
          //   onPressed: () {},
        ...
        child: Column(
          children: [
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FilterChip(
                    ...
                    avatar: Container(width: 16, height: 16, decoration: BoxDecoration(color: category.color, shape: BoxShape.circle)),
                    selected: isSelected,
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) => NoteCard(note: notes[index], onTap: () => _navigateToNoteView(context, notes[index])),
            ),
          ],
        ),
      ),
  ...
  Widget _buildSortOption(BuildContext context, String title, SortMode mode, SortMode currentMode, WidgetRef ref) {
    return ListTile(
      title: Text(title),
  ...
  void _navigateToNoteView(BuildContext context, Note note) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => NoteViewScreen(note: note)));
  }
}
